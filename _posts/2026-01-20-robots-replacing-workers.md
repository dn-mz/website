...
You might have seen this argument before. [Elon Musk](https://www.businessinsider.com/elon-musk-says-optimus-eliminate-poverty-2025-11){: .custom-link} said that humanoid robots will elimate poverty. I've seen tons of robot start-up decks' and website's making the same claim.
...
There may also be a bucket where easy or easily automatable work gets replaced by robots too. We see this in large language models now. Finance or legal work isn't dirty, dangerous or demeaning, but is getting increasingly automatable by LLMs. This argument holds, but for robotics is still subject to a much floor on costs, so there is a little more consideration required here. Just because something is easily automatable doesn't mean it will be replaced once unit economics are considered.

I don't think many people are thinking too hard or critically about this issue right now, as this is still a future that seems quite distant. Fair. Yet, similar to what I raised in my [thesis on robot learning in my robotics post](/blog/why-robotics){: .custom-link}, I think careful consideration of what the future may or should be gives us greater wisdom in how we can build more wisely.

Those nervous looks on the factory floor are not just a reaction to my robots today, but to the choices we are making now about the kinds of work we decide robots do tomorrow.

I hope to be part of building that tomorrow. I am excited.
